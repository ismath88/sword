<?php
	...
	class OrderUI extends Dashboard {
		
		protected $headerTitle = "Order Dashboard";
		...
		protected function pdq() {
			...
			*/
			...
			$ary_x = array(
				"Order Status: <select id=\"ACTIVITY_TYPE\" name=\"ACTIVITY_TYPE\">". $str_ordStatusList ."</select>",
				array("TEAM_ID: <input type=\"text\" id=\"TEAM_ID\" name=\"TEAM_ID\" value=\"\" />",array("search_like"=>true))
