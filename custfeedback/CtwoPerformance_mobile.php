...
class CtwoPerformance_mobile extends gui {

    protected function content() {


        $mobile_valid_user = util::fetch('mobile_staff_no');
...
//        $this->importPlugin('sword/js/fullcalendar.min.js');
        ...
        $form = " <div style=\"background:#EEA244;text-align:center;font-weight:bold;\">CTWO - Performance Team</div><br>
<input type='hidden' id='mobilestaffno' value=$mobile_valid_user />            
<table cellpadding='5' cellspacing='50'>    
        ...
        return $form . $this->performance($monthyear, $yearonly, $week_start, $week_end, $mobile_valid_user);
    }
...
var uri = encodeURIComponent('monthyear='+ mon_year);
               ...
               var mobile_staffno = $('#mobilestaffno').val();         
            
         window.location.href = '?clsid=CtwoPerformance_mobile&clspar='+encodeURIComponent('mobile_staff_no='+mobile_staffno+'&monthyear='+ mon_year);
...
$('#fltr_year').change(function(){
      ...
      var year = $(this).val();
        var mobile_staffno = $('#mobilestaffno').val();      
      window.location.href = '?clsid=CtwoPerformance_mobile&clspar='+encodeURIComponent('mobile_staff_no='+mobile_staffno+'&year='+year);
...
var startDate;
 ...
 $('#week-picker').datepicker({
  ...
  var mobile_staffno = $('#mobilestaffno').val();      
                             window.location.href = '?clsid=CtwoPerformance_mobile&clspar='+encodeURIComponent('mobile_staff_no='+mobile_staffno+'&startdate='+week_start+'&enddate='+week_end);
                        },
